...
function LSP_display_area() {
  ...
  function createNav(o){
    navhtml = '<p class="menu" id="' + LSP_display_area.prototype.getName(o.parent) + '_menu">';
  ...
  function bindHandlers(o){
    ...
    // Previous page
    $('p#' + LSP_display_area.prototype.getName(o.parent) + '_menu a.menu_prev_link').live('click', function(event){
      event.preventDefault();
      o.parent.previousPage();
    });
    // Jump to page
    $('p#' + LSP_display_area.prototype.getName(o.parent) + '_menu a.menu_page_link').live('click', function(event){
      event.preventDefault();
      o.parent.displayPage($(this).attr("title"));
    });
    // Next page
    $('p#' + LSP_display_area.prototype.getName(o.parent) + '_menu a.menu_next_link').live('click', function(event){
   	  event.preventDefault();
   	  o.parent.nextPage();
   	});
  }
  ...
  function unbindHandlers(o){
    $('p#' + LSP_display_area.prototype.getName(o.parent) + '_menu a.menu_prev_link').die('click');
    // Jump to page
    $('p#' + LSP_display_area.prototype.getName(o.parent) + '_menu a.menu_page_link').die('click');
    // Next page
    $('p#' + LSP_display_area.prototype.getName(o.parent) + '_menu a.menu_next_link').die('click');
...
LSP_display_area.prototype.getName = function(x){
    for(var i in window){
